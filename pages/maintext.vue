<template>
  <div id="main">
    ...
    <div v-if="$cookie.get('language') == 'dutch'" class="content">
      ...
      <p>Van 18 t/m 22 augustus is Delft een groot feest, speciaal voor jou als eerstejaars. De OWee is jouw moment om jezelf opnieuw uit te vinden en te ontdekken wat er nu echt bij jou past.</p>
    ...
    <div v-if="$cookie.get('language') == 'english'" class="content">
      ...
      <p>From August 18th to the 22nd, Delft is a big party, especially for you as a first-year student. The OWee is your time to reinvent yourself and discover what really fits you.</p>
